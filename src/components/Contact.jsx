              ...
              <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                ...
                <form id="contactForm">
                  <div className="mb-6">
                    <div className="mx-0 mb-1 sm:mb-4">
                      <div className="mx-0 mb-1 sm:mb-4">
                        ...
                        <input
                          ...
                          className="mb-2 w-full opacity-25 rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md sm:mb-0"
                          name="name"
                        />
                      </div>
                      <div className="mx-0 mb-1 sm:mb-4">
                    ...
                    <div className="mx-0 mb-1 sm:mb-4">
                      ...
                      <textarea
                        ...
                        className="mb-2 w-full opacity-25  rounded-md border border-gray-400 py-2 pl-2 pr-4  sm:mb-0"
                      ></textarea>
                    </div>
                  </div>
                  <div className="text-center">
                    <button
                      type="submit"
                      className="w-full bg-white text-secondary font-bold px-6 py-3 font-xl rounded-md sm:mb-0"
                    >
                      Send Message
                    </button>
                  </div>
